...
async def fill_fields(
    ...
    tasks.append(get_gadgets(stats, BF6.GADGETS, settings_translation))
    tasks.append(get_gadgets(stats, BF6.GADGET_GROUPS, settings_translation))
    tasks.append(get_melee(stats, BF6.MELEE, settings_translation))
    tasks.append(get_melee(stats, BF6.MELEE_GROUPS, settings_translation))
    tasks.append(get_battle_pickups(stats, BF6.BATTLE_PICKUPS, settings_translation))
    tasks.append(get_vehicles(stats, BF6.VEHICLE_ARCHETYPES, settings_translation))
...
async def get_main_stats(stats_dict: dict, format_values: bool = True):
    ...
    return {
        ...
        "lastPlacement": stats_dict.get("placement_last", 0),
        "dividedKills": {
            "confirmed": stats_dict.get("killconfirmed_total", 0),
            "fullConfirmed": stats_dict.get("killconfirmed_y_total", 0),
            # "lastSquadPers": stats_dict.get("killconfirmed_last", 0),
        ...
        "devidedDamage": {
            "human": stats_dict.get("Dmg_Dealt_human_Total", 0),
            "explosive": stats_dict.get("Dmg_Dealt_Explosive_Total", 0),
            ...
            "withVehicle": stats_dict.get("Dmg_Dealt_W_Veh_Total", 0),
            "inRound": {
